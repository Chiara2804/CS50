...
/*il voto sulla pluralit� presenta alcuni svantaggi. Cosa succede, ad esempio, in un'elezione con tre candidati le schede danno un parimerito tra 2 candidati?
Esiste un altro tipo di sistema di voto noto come sistema di voto a scelta classificata. 
In un sistema di scelta classificata, gli elettori possono votare per pi� di un candidato. 
Invece di votare solo per la loro prima scelta, possono classificare i candidati in ordine di preferenza. 
Qui ogni votante, oltre a specificare il primo candidato di preferenza, ha indicato anche la seconda e la terza scelta. 
E ora, quello che prima era un'elezione a parit� di voti ora potrebbe avere un vincitore. 
La gara era originariamente a pari merito tra Alice e Bob, quindi Charlie era fuori dai giochi. 
Ma l'elettore che ha scelto Charlie ha preferito Alice a Bob, quindi Alice potrebbe qui essere dichiarata vincitrice. 
*/
